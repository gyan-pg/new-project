  ...
  return (
    <div className="text-center">
      <div className="inline-block relative">
        <h2 className="text-center">{trainingTitle}:総負荷グラフ<button disabled={movingFlg} onClick={() => toggleShow()}><AiOutlineQuestionCircle className="inline-block hover:cursor-pointer" style={{ position: "relative", top: "-2px" }}/></button></h2>
        {showFlg ?
